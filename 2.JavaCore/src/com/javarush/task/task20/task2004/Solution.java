...
//            File yourFile = File.createTempFile("your_file_name", null);
            File yourFile = new File("f:\\1.dat");
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            properties.put("static", this.staticString);
...
//            objectOutputStream.close();
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            staticString = properties.getProperty("static");
            i = Integer.parseInt(properties.getProperty("i"));
            j = Integer.parseInt(properties.getProperty("j"));

//            ObjectInputStream objectInputStream = new ObjectInputStream(inputStream);
//            Object newClassWithStatic = objectInputStream.readObject();
//            i = ((ClassWithStatic) newClassWithStatic).i;
//            j = ((ClassWithStatic) newClassWithStatic).j;
