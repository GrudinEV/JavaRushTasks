...
public class Rocket extends GameObject {
    ...
    public Rocket(double x, double y) {
        ...
        List<int[][]> listDownFireMatrix = new ArrayList<>();
        listDownFireMatrix.add(ShapeMatrix.FIRE_DOWN_1);
        listDownFireMatrix.add(ShapeMatrix.FIRE_DOWN_2);
        listDownFireMatrix.add(ShapeMatrix.FIRE_DOWN_3);
        downFire = new RocketFire(listDownFireMatrix);
        List<int[][]> listSideFireMatrix = new ArrayList<>();
        listSideFireMatrix.add(ShapeMatrix.FIRE_SIDE_1);
        listSideFireMatrix.add(ShapeMatrix.FIRE_SIDE_2);
        leftFire = new RocketFire(listSideFireMatrix);
        rightFire = new RocketFire(listSideFireMatrix);
    }
